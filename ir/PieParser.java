...
public class PieParser extends Parser {
    ...
    public final program_return program() throws RecognitionException {
        ...
        Token EOF3=null;
        functionDefinition_return functionDefinition1 = null;
    ...
    public final structDefinition_return structDefinition() throws RecognitionException {
        ...
        Token NL10=null;
        vardef_return vardef6 = null;

        vardef_return vardef8 = null;
    ...
    public final functionDefinition_return functionDefinition() throws RecognitionException {
        ...
        vardef_return vardef14 = null;

        vardef_return vardef16 = null;

        slist_return slist18 = null;
    ...
    public final slist_return slist() throws RecognitionException {
        slist_return retval = new slist_return();
        retval.start = input.LT(1);
        ...
        Token NL23=null;
        statement_return statement21 = null;
    ...
    public final statement_return statement() throws RecognitionException {
        ...
        slist_return el = null;

        structDefinition_return structDefinition25 = null;

        qid_return qid26 = null;
        ...
        slist_return slist41 = null;

        call_return call42 = null;
    ...
    public final expr_return expr() throws RecognitionException {
        ...
        Token set51=null;
        addexpr_return addexpr50 = null;

        addexpr_return addexpr52 = null;
    ...
    public final addexpr_return addexpr() throws RecognitionException {
        addexpr_return retval = new addexpr_return();
        retval.start = input.LT(1);

        PieAST root_0 = null;

        Token set54=null;
        mulexpr_return mulexpr53 = null;

        mulexpr_return mulexpr55 = null;
    ...
    public final mulexpr_return mulexpr() throws RecognitionException {
        mulexpr_return retval = new mulexpr_return();
        retval.start = input.LT(1);

        PieAST root_0 = null;

        Token char_literal57=null;
        atom_return atom56 = null;

        atom_return atom58 = null;
    ...
    public final atom_return atom() throws RecognitionException {
        ...
        qid_return qid63 = null;

        call_return call64 = null;

        instance_return instance65 = null;
    ...
    public final instance_return instance() throws RecognitionException {
        instance_return retval = new instance_return();
        retval.start = input.LT(1);
